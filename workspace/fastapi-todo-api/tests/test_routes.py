...
async def test_update_todo():
    response = client.post("/todos/", json={"title": "Update Todo", "description": "To be updated."})
...
async def test_delete_todo():
    response = client.post("/todos/", json={"title": "Delete Todo", "description": "To be deleted."})
    todo_id = response.json()["id"]
